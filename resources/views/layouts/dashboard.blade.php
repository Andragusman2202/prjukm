  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{url('/dashboard/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Unit Kegiatan Mahasiswa</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('home1')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tabel Anggota</p>
              ...
              <li class="nav-item">
                <a href="{{url('home3')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tabel Agenda </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('home4')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tabel Galery </p>
                </a>
              </li>
